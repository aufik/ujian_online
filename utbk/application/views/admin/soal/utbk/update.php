                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form id="form_advanced_validation" method="POST" action="<?=base_url();?>admin/soal/utbk/update/do_update/<?=$so->soal_id;?>">
                                <div class="row clearfix">
                                ...
                                <div  id="jwb_essay" class="<?php if($so->soal_type_jawaban != '2') echo "hidee"; ?> ">
                                    <div class="header">
                                        ...
                                        <br/>BOBOT:<input type="number" name="bobot[]" style="width:100px"  value="1" value="<?=@$jawaban_essay->essay_bobot?>"/>
                                    </div>
                                    <div class="body">

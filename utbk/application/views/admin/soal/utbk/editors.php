<script src="<?=base_url();?>assets/admin/plugins/tinymce/tinymce.min.js"></script>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart(base_url().'admin/soal/utbk/tambah/do_create');?>
  ...
  tinymce.init({
    ...
    image_advtab: true,
        ...
        // content_css: [
        //     base_url+'assets/admin/plugins/tinymce/font_googleapis.css',
        //     base_url+'assets/admin/plugins/tinymce/codepen.min.css'
        // ],
        file_browser_callback: function(field, url, type, win) {
            tinyMCE.activeEditor.windowManager.open({
                file: base_url()+"assets/admin/plugins/kcfinder/browse.php?opener=tinymce4&field=" + field + "&type=" + type,// sesuikan direktory KCfinder
                title: 'File Manager',
                width: 900,
                height: 550,
                inline: true,
...
tinyMCE.init({
        ...
        content_css: [
            base_url+'assets/admin/plugins/editor/tinymce/font_googleapis.css',
            base_url+'assets/admin/plugins/editor/tinymce/codepen.min.css'
        ],
        file_browser_callback: function(field, url, type, win) {
            tinyMCE.activeEditor.windowManager.open({
                file: base_url+'assets/admin/plugins/editor/kcfinder/browse.php?opener=tinymce4&field=' + field + '&type=' + type,// sesuikan direktory KCfinder
                title: 'File Manager',
                width: 900,
                height: 550,
                inline: true,

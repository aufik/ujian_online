 <section class="content">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> 
                                                <a href="<?=base_url()?>admin/peserta/sekolah/update/<?=$sp->sekolah_peserta_id?>"><button class="btn btn-info waves-effect" type="button">Cari</button></a>
                                            </td>
  ...
  <div class="modal fade" id="mdModal" tabindex="-1" role="dialog">
                ...
                <form class="form-horizontal" method="POST" action="<?=base_url();?>admin/peserta/sekolah/tambah_relasi/">

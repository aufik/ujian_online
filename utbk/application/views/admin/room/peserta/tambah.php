...
input[type="text"]:disabled {
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="<?=base_url();?>admin/room/peserta/tambah/do_create/<?=$room?>">
                            <div class="row clearfix">
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td> Peserta '+i+'</td><td><input type="text" name="peserta_username[]" class="form-control"  placeholder="Masukan Username Peserta '+i+'" ></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  

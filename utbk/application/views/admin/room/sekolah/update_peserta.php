    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                <a href="<?=base_url();?>admin/room/sekolah/list_peserta/<?=$sekolah?>/<?=$room?>/"><button class="btn btn-warning waves-effect" type="button">Kembali</button></a>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="<?=base_url();?>admin/room/peserta/update_peserta/do_update/<?=$sekolah?>/<?=$room?>/<?=$ps->peserta_id?>">
                            <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                 <input type="text" name="nisn" class="form-control" value="<?=$ps->peserta_nomor?>"  placeholder="Masukan Username" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>

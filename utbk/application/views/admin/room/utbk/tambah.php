                            ...
                            <form class="form_advanced_validation" method="POST" action="<?=base_url();?>admin/room/utbk/tambah/do_create/"> 
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                            <input name="option_ujian_jawaban" type="radio" id="option_ujian_jawaban_1"  class="with-gap" value="1" />
                                            <label for="option_ujian_jawaban_1">Saintek</label>
                                            <input name="option_ujian_jawaban" type="radio" id="option_ujian_jawaban_2" class="with-gap" value="2"/>
                                            <label for="option_ujian_jawaban_2">Soshum</label>
                                            <input name="option_ujian_jawaban" type="radio" id="option_ujian_jawaban_3" class="with-gap" value="3"/>

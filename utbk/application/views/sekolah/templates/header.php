...
<head>
    ...
    <!-- editor tinymce -->
    <!-- <script src="<?=base_url();?>assets/admin/plugins/tinymce/tinymce.min.js"></script> -->
    <!-- <script type="text/javascript" src="<?php echo base_url('assets/admin/plugins/editor/tinymce/tinymce.min.js');?>"></script> -->

    <!-- editor ckeditor -->
    <script type='text/javascript' src='<?php echo base_url(); ?>assets/admin/plugins/editorku/ckeditor/ckeditor.js'></script>

    <!-- editor kcfinder  -->
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/plugins/editorku/kcfinder/kcfinder.js"></script>

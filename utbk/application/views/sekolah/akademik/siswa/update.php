    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                <a href="<?=base_url();?>sekolah/akademik/siswa/"><button class="btn btn-warning waves-effect" type="button">Kembali</button></a>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="<?=base_url();?>sekolah/akademik/siswa/update/do_update/<?=$s->siswa_id;?>">
